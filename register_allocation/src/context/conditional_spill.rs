...
pub fn spill_var(
    ...
    let inner_res =
        linear_spill::determine_spill_var(largest_vars.clone(), largest_block, start_index, end);

    SpillResult::InnerVariable {
        var: inner_res.var,
        load_block: inner_res.load_block,
        load_index: inner_res.load_index,
    }
}
